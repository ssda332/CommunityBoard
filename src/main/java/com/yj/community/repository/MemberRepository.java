...
public interface MemberRepository {
    ...
    @Select("SELECT U.MEM_USERID, U.MEM_PASSWORD, R.ROLE_NAME FROM TB_USER U JOIN TB_USER_ROLE UR ON (U.MEM_ID = UR.MEM_ID2) JOIN TB_ROLE R ON (UR.ROLE_CODE = R.ROLE_CODE) WHERE U.MEM_USERID = #{username}")
    @Results({
